...
public interface empdetailsRepository extends JpaRepository<employeeClass, Long> {//JpaRepository is inbuilt interface interacts with db and hibernate interacts with queries, contains table name(class name) and primary key datatyoe(wrapper class)
}
